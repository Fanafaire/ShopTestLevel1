...
public class ProductsNodeAdapter extends RecyclerView.Adapter<ProductsNodeAdapter.ViewHolder>{

    private final LayoutInflater inflater;
    private final ArrayList<ProductNode> products;

    public ProductsNodeAdapter(Context context, ArrayList<ProductNode> products) {
    ...
    @Override
    public void onBindViewHolder(ProductsNodeAdapter.ViewHolder holder, int position) {
